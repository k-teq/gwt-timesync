...
function create(options) {
  var timesync = {
    ...
    receive: function receive(from, data) {
      ...
      // console.log("inProgress",timesync._inProgress)
      //
      // console.log("inProgress",timesync._inProgress[data.id])
      // console.log("inProgress",timesync._inProgress[0])
